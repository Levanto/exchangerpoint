...
public class Constants {
  ...
  static final String PAYMENT_UPI_TRANSFER_GET = "payments/%s/upi_transfer";
  ...
  static final String FETCH_PAYOUT = "payouts/%s";
  static final String FETCH_ALL_PAYOUT = "transactions";
}
