...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Bitcoin with National Bank Transfer UK. Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
<meta name="keywords" content="buy, Bitcoin, paym,uk,transfer,eth,buy-Bitcoin-bank-transfer,buy-Bitcoin,buy-Bitcoin-with-bank,buy-eth,buy-eth-with-online-transfer,btc-with-paym,ecurrency,e-currency,exchange">
...
if(ORDER_TYPE == "E")
{
$("#exchangesuccess").html("<p style='color:green' >Your order number <b>" + ORDER_ID + "</b> has been succesfully submitted<br>Please transfer  " + $("#exchangeamount").val() + " GBP  below bank account</p></br><p style='color:blue'><br>Bank Name  Lloyd Bank <br> Account Holder GOVIND SINGH <br> Bank ACCOUNT 78541460 <br>Sort Code 309691</p>");
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature ordeformHeader"
						...
						<div id="exchangeForm" name="exchangeform"
							...
							<h4 style="color: white">Buy Bitcoin Bank transfer UK</h4>
							<!-- progressbar -->
