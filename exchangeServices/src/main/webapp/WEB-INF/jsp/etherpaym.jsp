...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Ether with Paym (UK) .Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
<meta name="keywords" content="buy, ether,ethereum, paytm,uk,eth,buy-ether-paym,buy-ether,buy-ether-with-paym,buy-eth,buy-eth-with-paym,btc-with-paym,ecurrency,e-currency,exchange">
<meta name="author" content="Govind Singh">
<meta name="language" content="English">
<title>Buy Bitcoin with Paym UK</title>
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature ordeformHeader"
						...
						<div id="exchangeForm" name="exchangeform"
							...
							<h4 style="color: white">Buy Ether Paym (UK)</h4>
							<!-- progressbar -->
