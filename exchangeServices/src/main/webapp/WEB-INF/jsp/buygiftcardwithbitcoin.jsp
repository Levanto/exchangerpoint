...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Gift Cards with Bitcoins. Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
<meta name="keywords" content="Buy,amazon,giftcard,flipkart,myntra,online,btc,bitcoin,buy-gift,buy-giftcard-withbitcoin,india">
<meta name="author" content="Govind Singh">
<meta name="language" content="English">
<title>Buy GiftCards with Bitcoin</title>
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature ordeformHeader"
						...
						<div id="sellFormB" class="img-responsive orderform">
							<h4 style="color: white">Buy Giftcard With Bitcoin</h4>
							<!-- progressbar -->
							<ul class="progressbar">
								<li class="active">Giftcard Order</li>
								<li>Verify Order</li>
								<li>Make Payment</li>
							</ul>
							<!-- fieldsets-->
							...
							<fieldset class="img-responsive">
								<h2 class="fs-title">Giftcard Order</h2>
								<br>
				...
				<p style="font-size: 17px;  text-align: justify;text-justify: inter-word;">We know how much you love privacy and want to buy something online secretly.So we have design this order form for you. You can buy all india major gift cards with bitcoins like amazon, flipkart and myntra etc. Its simple and we wont ask you any information that like what you want to buy with gift card. You can simply place order and pay with bitcoins and grab your giftcard in your mailbox .We will buy it for you online with our own money so it is safe to use this giftcards.
				<br><br> <b>Procedure</b>-- Just enter amount and click next. Verify your order with OTP send to your email and mobile. Once verified you will see our Bitcoin address and QR code just scan and pay. We will verify the payment and send you giftcard to your email.
