...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Bitcoin with Bank Transfer India. Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
<meta name="keywords" content="buy, Bitcoin, buy-bitcoin,india,bank-transfer,bank,imps,neft,imps,upi,buy,coins,btc,buy-but-india,buy-with-imps,bitcoin-india">
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature ordeformHeader"
						...
						<div id="exchangeForm" name="exchangeform"
							...
							<h4 style="color: white">Buy Bitcoin With Bank Transfer India</h4>
							<!-- progressbar -->
				...
				<p style="font-size: 17px;  text-align: justify;text-justify: inter-word;"> You can buy bitcoin with at your home by bank transfer by netbanking or any mobile banking app.You can buy bitcoin with NEFT, IMPS, UPI etc.Best way to buy bitcoin with bank transfer is IMPS. Now You can place direct order here to buy bitcoin in India.
				<br><br> <b>Procedure</b>-- Just enter amount and your bitcoin address and click next. Verify your order with OTP send to your email and mobile. Once verified you will see our bank details.Just note down the details and make the payment. We will verify the payment and send you bitcoins to your address.
