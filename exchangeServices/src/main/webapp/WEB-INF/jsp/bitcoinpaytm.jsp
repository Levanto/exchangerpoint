...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Bitcoin with PayTM (India). Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
...
<title>Buy Bitcoin with PayTM India</title>
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature ordeformHeader"
						...
						<div id="exchangeForm" name="exchangeform"
							...
							<h4 style="color: white">Buy Bitcoin Paytm (India)</h4>
							<!-- progressbar -->
				...
				<p style="font-size: 17px;  text-align: justify;text-justify: inter-word;"> You are at right place to buy bitcoin with PayTM. We understand it was never easy to buy bitcoins with PayTM so we have design special order form on ExchangerPoint.Now You can place direct order here to buy bitcoin in India.
				<br><br> <b>Procedure</b>-- Just enter amount and your bitcoin address and click next. Verify your order with OTP send to your email and mobile. Once verified you will see our PayTM number and QR code just scan and pay. We will verify the payment and send you bitcoins to your address.
