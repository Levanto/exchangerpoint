...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Ripple with UK Bank Transfer.Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
<meta name="keywords" content="buy, Ripple, paytm,uk,eth,buy-Ripple-paytm,buy-Ripple,buy-Ripple-with-paytm,buy-eth,buy-eth-with-paytm,btc-with-paytm,ecurrency,e-currency,exchange">
<meta name="author" content="Govind Singh">
<meta name="language" content="English">
<title>Buy Ripple with Bank Transfer UK</title>
...
if(ORDER_TYPE == "E")
{
$("#exchangesuccess").html("<p style='color:green' >Your order number <b>" + ORDER_ID + "</b> has been succesfully submitted<br>Please transfer  " + $("#exchangeamount").val() + " GBP  below bank account</p></br><p style='color:blue'><br>Bank Name  Transferwise <br> Account Holder KIRANJEET KAUR <br> Bank ACCOUNT 15174598 <br>Sort Code 231470</p>");
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature ordeformHeader"
						...
						<div id="exchangeForm" name="exchangeform"
							...
							<h4 style="color: white">Buy Ripple Bank Transfer (UK)</h4>
							<!-- progressbar -->
							...
							<fieldset class="img-responsive">
								...
								<div id="exchangeerror" style="">&nbsp;</div>
								       ...
								       <input type="hidden" name="from" id="exchangefrom" value="GPB" />
