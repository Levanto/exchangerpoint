...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Ether with PayTM, IMPS, NEFT Bank Transfer in India.Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
...
<title>Buy Ether in INDIA</title>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<ul class="nav navbar-nav navbar-right">
					<li ><a href="/buy-bitcoin-in-india.htm">BUY BITCOIN INDIA</a></li>
					<li class="active"><a href="/buy-ethereum-in-india.htm">BUY ETHER INDIA</a></li>
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature first ordeformHeader"
						...
						<div id="exchangeForm" name="exchangeform"
							...
							<h4 style="color: white">Buy Ether IN INDIA</h4>
							<!-- progressbar -->
