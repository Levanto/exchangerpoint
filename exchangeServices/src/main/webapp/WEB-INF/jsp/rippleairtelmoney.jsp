...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Ripple with Airtel Money (India).Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
<meta name="keywords" content="buy, Ripple, paytm,uk,eth,buy-Ripple-paytm,buy-Ripple,buy-Ripple-with-airtel-money,buy-eth,buy-eth-with-airtel-money,btc-with-paytm,ecurrency,e-currency,exchange">
<meta name="author" content="Govind Singh">
<meta name="language" content="English">
<title>Buy Ripple with Airtel Money India</title>
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature ordeformHeader"
						...
						<div id="exchangeForm" name="exchangeform"
							...
							<h4 style="color: white">Buy Ripple Airtel Money (India)</h4>
							<!-- progressbar -->
							...
							<fieldset class="img-responsive">
								...
								<div id="exchangeerror" style="">&nbsp;</div>
								       ...
								       <input type="hidden" name="from" id="exchangefrom" value="INR" />
