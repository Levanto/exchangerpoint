...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Ether with Barclays Pingit (UK).Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
<meta name="keywords" content="buy, ether,ethereum, pingit,uk,eth,buy-ether-pingit,buy-ether,buy-ether-with-pingit,buy-eth,buy-eth-with-pingit,btc-with-pingit,ecurrency,e-currency,exchange">
<meta name="author" content="Govind Singh">
<meta name="language" content="English">
<title>Buy Bitcoin with Pingit UK</title>
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature ordeformHeader"
						...
						<div id="exchangeForm" name="exchangeform"
							...
							<h4 style="color: white">Buy Ether Pingit (UK)</h4>
							<!-- progressbar -->
							...
							<fieldset class="img-responsive">
								...
								<div id="exchangeerror" style="">&nbsp;</div>
									...
									placeholder="Amount in Pounds" maxlength="10"  onblur="getExchangeFees();"  />
