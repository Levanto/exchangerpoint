...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Ripple with PayTM, IMPS, NEFT Bank Transfer in India.Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
...
<title>Buy Ripple in INDIA</title>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="active"><a href="/buy-ripple-in-india.htm">BUY RIPPLE INDIA</a></li>
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature first ordeformHeader"
						...
						<div id="exchangeForm" name="exchangeform"
							...
							<h4 style="color: white">Buy Ripple IN INDIA</h4>
							<!-- progressbar -->
