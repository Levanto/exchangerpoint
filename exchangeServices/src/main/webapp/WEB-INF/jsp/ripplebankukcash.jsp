...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Ripple with Cash Deposit UK .Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
<meta name="keywords" content="buy, Ripple, paytm,uk,eth,deposit, bank,buy-Ripple-cash,buy-Ripple,buy-Ripple-with-cash,buy-eth,buy-eth-with-paytm,btc-with-paytm,ecurrency,e-currency,exchange">
<meta name="author" content="Govind Singh">
<meta name="language" content="English">
<title>Buy Ripple with Bank Deposit UK</title>
...
if(ORDER_TYPE == "E")
{
$("#exchangesuccess").html("<p style='color:green' >Your order number <b>" + ORDER_ID + "</b> has been succesfully submitted<br>Please make cash deposit of " + $("#exchangeamount").val() + " GBP  below bank account</p></br><p style='color:blue'><br>Bank Name  Santander <br> Account Holder Govind Singh <br> Bank ACCOUNT 12339006 <br>Sort Code 090129 <br> Please send deposit receipt to support@exchangerpoint.com</p>");
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="active"><a href="/buy-ripple-with-bitcoin.htm">BUY RIPPLE</a></li>
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature ordeformHeader"
						...
						<div id="exchangeForm" name="exchangeform"
							...
							<h4 style="color: white">Buy Ripple Cash Deposit (UK)</h4>
							<!-- progressbar -->
							<ul class="progressbar">
								<li class="active">Buy Ripple</li>
								<li>Verify</li>
								<li>Success</li>
							</ul>
							<!-- fieldsets -->
							<fieldset class="img-responsive">
								<h2 class="fs-title">Buy Ripple Order</h2>
								<div id="exchangeerror" style="">&nbsp;</div>
								       <input type="hidden" name="exchangeto" id="exchangeto" value="Ripple" />			
								
								       <input type="hidden" name="from" id="exchangefrom" value="GBP" />
								
								       <input type="text" name="amount" id="exchangeamount"
									placeholder="Amount in Pound" maxlength="10"  onblur="getExchangeFees();"  />
									
									
									
									<input type="text" id="exchangewalet"
									name="exchangewalet" placeholder="Enter Your Ripple Address"
									maxlength="100"  />
									
									<input
									type="button" style="margin-top: 2%" class="action-button"
									...
									style="border: 0 !important; color: green ; font-weight: bold;" placeholder=""
									readonly="readonly" /> 
									
									<label class="chkRadio" style="color: red"
									id="lblExchangeValidationMsg">&nbsp;</label> 
							</fieldset>
							<fieldset class="img-responsive">
								...
								<div class="validationDiv">
									...
									<!-- exchangeverifyerror -->
									   <input type="text" class="userEmail" id="exchangeemail"
										...
										style="margin-top: 0px;" placeholder="Example +911234567890"
										maxlength="15" />
							...
							<fieldset class="img-responsive">
								<div id="exchangesuccess"style="color: green; margin-top: 5px; font-weight: bold;">&nbsp;</div>
				...
				<br><p>Ripple works with banks to transform how they send money around the world.Global commerce is rapidly changing. Businesses are increasingly global from day one and consumers are programmed to expect on demand delivery of services and information. Yet, the current infrastructure for payments is woefully inadequate to meet these needs.. On Exchangerpoint, you can buy Ripple for Bitcoin, for US Dollars , GBP, Euro and INR.
				...
				<a href="https://exchangerpoint.com/buy-ripple-with-upi-india.htm"> Buy Ripple With UPI Transfer (BHIP APP or Bank Apps)</a>&nbsp
				<a href="https://exchangerpoint.com/buy-ripple-with-unified-payment-interface-india.htm"> Buy Ripple With Unified Payment Interface INDIA </a>&nbsp
				<a href="https://exchangerpoint.com/buy-ripple-with-airtel-money-india.htm"> Buy Ripple With Airtel Money </a>
				<a href="https://exchangerpoint.com/buy-ripple-with-bitcoin.htm">Buy Ripple With Bitcoin</a>
				<a href="https://exchangerpoint.com"> Buy Ripple With INR</a>
