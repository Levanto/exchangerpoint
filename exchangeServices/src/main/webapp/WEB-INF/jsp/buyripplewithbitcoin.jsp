...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Ripple with Bitcoin.Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
<meta name="keywords" content="buy, ripple,ripple,uk,btc,buy-ripple-paytm,buy-ripple,buy-ripple-with-bitcoin,buy-eth,buy-eth-with-btc,eth-with-btc,ecurrency,e-currency,exchange">
<meta name="author" content="Govind Singh">
<meta name="language" content="English">
<title>Buy Ripple with Bitcoin</title>
...
<script type="text/javascript">
		function printmessageinpage() {
			...
			var dateinformat = dateArr[1] + " " + dateArr[2] + " " + dateArr[3]
					+ " " + dateArr[4];

			if (ORDER_TYPE == "E")
				{
				$("#exchangesuccess")
				.html("<p style='color:green' >Your order number <b>"
						+ ORDER_ID
						+ " </b> has been succesfully submitted.<br>Please send "
						+ $("#exchangeamount").val()+ " BTC "
						+ "to our bitcoin address 14S4WmNELz7m2ksq5ayskhkqVnCrK3BPp4.<br> OR scan below QR code</p>");
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature ordeformHeader"
						...
						<div id="exchangeForm" name="exchangeform"
							...
							<h4 style="color: white">Buy Ripple With Bitcoin</h4>
							<!-- progressbar -->
							...
							<fieldset class="img-responsive">
								...
								<div id="exchangeerror" style="">&nbsp;</div>
								       ...
								       <input type="hidden" name="from" id="exchangefrom" value="Bitcoin" />
								
								       <input type="text" name="amount" id="exchangeamount"
									placeholder="Amount" maxlength="10"  onblur="getExchangeFees();"  />
							...
							<fieldset class="img-responsive">
								<div id="exchangesuccess"style="color: green; margin-top: 5px; font-weight: bold;">&nbsp;</div> 
									<img class="exchangesuccessImgclass" src="img/bitcoin-address.jpg" style="margin-bottom: 5px; margin: -2% 0%;"/>										
							</fieldset>
						</div>
