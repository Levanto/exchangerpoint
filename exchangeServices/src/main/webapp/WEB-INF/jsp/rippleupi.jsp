...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Ripple with UPI (India).Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
<meta name="keywords" content="buy, Ripple, paytm,upi,india,eth,buy-Ripple-upi,buy-Ripple,buy-Ripple-with-upi,buy-eth,buy-eth-with-paytm,btc-with-paytm,ecurrency,e-currency,exchange">
<meta name="author" content="Govind Singh">
<meta name="language" content="English">
<title>Buy Ripple with UPI India</title>
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature ordeformHeader"
						...
						<div id="exchangeForm" name="exchangeform"
							...
							<h4 style="color: white">Buy Ripple UPI (India)</h4>
							<!-- progressbar -->
