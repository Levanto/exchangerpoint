...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Ripple with Paym UK.Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
<meta name="keywords" content="buy, Ripple, paym,uk,eth,buy-Ripple-paym,buy-Ripple,buy-Ripple-with-paym,buy-eth,buy-eth-with-paym,btc-with-paym,ecurrency,e-currency,exchange">
<meta name="author" content="Govind Singh">
<meta name="language" content="English">
<title>Buy Ripple with Paym UK</title>
...
if(ORDER_TYPE == "E")
{
$("#exchangesuccess").html("<p style='color:green' >Your order number <b>" + ORDER_ID + "</b> has been succesfully submitted<br>Please send us " + $("#exchangeamount").val() + " GBP to our Paym number 07554642723.</p>");
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature ordeformHeader"
						...
						<div id="exchangeForm" name="exchangeform"
							...
							<h4 style="color: white">Buy Ripple Paym (UK)</h4>
							<!-- progressbar -->
