...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Bitcoin with Barclays Pingit UK. Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
<meta name="keywords" content="buy, Bitcoin, pingit,paym, uk,eth,buy-Bitcoin-pingit,buy-Bitcoin,buy-Bitcoin-with-pingit,buy-eth,buy-eth-with-pingit,btc-with-pingit,ecurrency,e-currency,exchange">
...
if(ORDER_TYPE == "E")
{
$("#exchangesuccess").html("<p style='color:green' >Your order number <b>" + ORDER_ID + "</b> has been succesfully submitted<br>Please send us " + $("#exchangeamount").val() + " GBP to our Pingit number 07466792553.</p>");
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature ordeformHeader"
						...
						<div id="exchangeForm" name="exchangeform"
							...
							<h4 style="color: white">Buy Bitcoin Pingit (UK)</h4>
							<!-- progressbar -->
