...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Ether with IMPS (India).Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
<meta name="keywords" content="buy, ether,ethereum, paytm,imps, india, eth,buy-ether-imps,buy-ether,buy-ether-with-imps,buy-eth,buy-eth-with-imps,btc-with-imps,ecurrency,e-currency,exchange">
<meta name="author" content="Govind Singh">
<meta name="language" content="English">
<title>Buy Bitcoin with IMPS India</title>
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature ordeformHeader"
						...
						<div id="exchangeForm" name="exchangeform"
							...
							<h4 style="color: white">Buy Ether IMPS (India)</h4>
							<!-- progressbar -->
