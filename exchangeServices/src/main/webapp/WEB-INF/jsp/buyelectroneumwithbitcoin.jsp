...
<head>
<meta charset="utf-8">
<meta name="description" content="Buy Electroneum with Bitcoin. Call or WhatsApp +919910922033 Skype ID Exchangerpoint">
<meta name="keywords" content="buy, ethereum,Electroneum,uk,btc,buy-Electroneum-paytm,buy-Electroneum,buy-Electroneum-with-bitcoin,buy-etn,buy-etn-with-btc,etn-with-btc,ecurrency,e-currency,exchange">
<meta name="author" content="Govind Singh">
<meta name="language" content="English">
<title>Buy Electroneum with Bitcoin</title>
			...
			<div class="row feature">
				...
				<div class="col-sm-4 feature ordeformHeader"
						...
						<div id="exchangeForm" name="exchangeform"
							...
							<h4 style="color: white">Buy Electroneum With Bitcoin</h4>
							<!-- progressbar -->
							<ul class="progressbar">
								<li class="active">Buy Electroneum</li>
								<li>Verify</li>
								<li>Success</li>
							</ul>
							<!-- fieldsets -->
							<fieldset class="img-responsive">
								<h2 class="fs-title">Buy Electroneum Order</h2>
								<div id="exchangeerror" style="">&nbsp;</div>
								       <input type="hidden" name="exchangeto" id="exchangeto" value="Electroneum" />			
									...
									name="exchangewalet" placeholder="Enter Your Electroneum Address"
									maxlength="100"  />
